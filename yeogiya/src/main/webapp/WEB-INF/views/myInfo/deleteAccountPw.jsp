...
<jsp:include page="../common/header.jsp" flush="false"/>
	<div class="container myInfo-container my-4">
		<form action="deleteRun" method="post" onsubmit="return validate();">
			<div class="h4 text-center">탈퇴하기</div>
			<div class="small text-center my-3">회원탈퇴를 위해 비밀번호를 입력해주세요.</div>
			...
			<div class="mt-4 row">
				<button type="submit" class="btn btn-pink btn-block">탈퇴</button>
			</div>
		</form>
	</div>
