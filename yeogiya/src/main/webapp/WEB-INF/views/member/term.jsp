...
본 약관과 회사와 회원간에 발생한 분쟁 등에 관하여는 대한민국 법령이 적용되며, 회사의 주소지를 관할하는 법원을 관할법원으로 합니다.
		...
		<!-- 위치기반서비스 이용약관 -->
			<div class="h4 mt-5 mb-3">위치기반서비스 이용약관</div>
			<div class="card">
			  <div class="card-body terms">
				<pre>
제 1 조 (목적) 
본 약관은 ㈜윤지(이하 "회사"라 합니다)가 운영, 제공하는 위치기반서비스(이하 “서비스”)를 이용함에 있어 회사와 고객 및 개인위치정보주체의 권리, 의무 및 책임사항에 따른 이용조건 및 절차 등 기본적인 사항을 규정함을 목적으로 합니다. 
...
2) 개인위치정보주체가 온라인 게시 등의 방법으로 통보할 것을 미리 요청한 경우
	...
	<script>
		...
		$("#allCheck").click(function() {
			...
			$("#serviceCheck").prop("checked", $(this).is(":checked"));
			$("#geoCheck").prop("checked", $(this).is(":checked"));
			$("#ageCheck").prop("checked", $(this).is(":checked"));
		})
